...
// The document is assembled in sections below, so its shape intentionally grows.
const options = {
  definition: {
    openapi: "3.0.3",
    info: {
...
const components = options.definition.components as typeof options.definition.components & {
...
schemas.CreateAppointmentRequest = {
  type: "object",
...
schemas.UpdateAppointmentRequest = {
  type: "object",
  properties: {
    doctorId: { type: "string", example: "507f1f77bcf86cd799439011" },
    patientId: { type: "string", example: "507f1f77bcf86cd799439012" },
